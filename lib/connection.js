...
Connection.prototype.connect = function () {
  ...
  this.resp
    .on('data', function (message) {
      ...
      // code changed to 401, 400 will remove
      if (ctx.connected && (res.payload.error.code === 400 || res.payload.error.code === 401)) ctx.connect()
